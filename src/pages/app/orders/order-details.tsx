...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle> Pedido: husa34mds</DialogTitle>
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">Tar Philips</TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="text-muted-foreground"> Telefone</TableCell>
              <TableCell className="flex justify-end">129999999</TableCell>
            </TableRow>
            <TableRow>
